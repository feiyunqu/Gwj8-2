 ...
 */
public class LvchuHistory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView=inflater.inflate(R.layout.fragment_lvchu_history, container, false);
        ...
        for (int k = 0; k < 13; k++) {
            dataList(lvchu20, "number", Myutils.DATA_TIMES[k], string_name);
        }
        cishu = lvchu20.size() - 1;
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (n < cishu) {
                    ...
                    text20.setText(lvchu20.get(cishu));
                    flag = false;
                    n++;
    ...
    private void dataList(ArrayList<String> array_data, String string, String times, String names) {
        String sqlstr = "select number from DataLvchu " +
