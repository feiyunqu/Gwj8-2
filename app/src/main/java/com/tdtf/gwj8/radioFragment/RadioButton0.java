 ...
 */
public class RadioButton0 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_radio_button0, container, false);
        ...
        Cursor cursor = dbhelper.getReadableDatabase().rawQuery(
                "select _id,powerData from Power where powerName=?", new String[]{"系统管理员"});
    ...
    public void setpower(CallBacks callBacks) {
        ...
        Log.d("ffff", "setpower: " + strBuilder.toString());
    }
}
