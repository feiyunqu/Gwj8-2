 ...
 */
public class RadioButton1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_radio_button1, container, false);
        ...
        Cursor cursor = dbhelper.getReadableDatabase().rawQuery(
                "select powerData from Power where powerName=?", new String[]{"操作员"});
